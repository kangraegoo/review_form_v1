      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-800">관리자 계정 목록</h2>
              ...
              {users.map(u => (
                <tr key={u.id} className={`hover:bg-gray-50 transition-colors ${!u.is_active ? 'opacity-40' : ''}`}>
                  <td className="px-4 py-3 font-medium text-gray-900">
                    ...
                    {me?.id === u.id && <span className="ml-1.5 text-[10px] px-1.5 py-0.5 bg-blue-100 text-blue-700 rounded font-bold">나</span>}
                  </td>
                  ...
                  <td className="px-4 py-3 text-center text-xs text-gray-400">{fmtDate(u.created_at)}</td>
                  <td className="px-4 py-3 text-center">
        ...
        {isSuper && (
          <div className="bg-white rounded-xl shadow-sm p-5">
            <h2 className="text-sm font-bold text-gray-800 mb-4">새 계정 추가</h2>
