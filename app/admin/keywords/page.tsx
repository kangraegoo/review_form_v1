  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <h1 className="text-xl font-bold text-gray-900 mb-5">키워드 설정</h1>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm mb-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">요청자</label>
              <input
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">구매옵션 *</label>
              <input
                value={form.option}
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">상품가 (원)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">리뷰비용 (원)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">리뷰타입</label>
              <input
              ...
              <tbody className="divide-y divide-gray-50">
                {rows.length === 0 ? (
                  ...
                  <tr key={r.id} className={`hover:bg-gray-50 transition-colors ${editId === r.id ? 'bg-blue-50' : ''}`}>
                    ...
                    <td className="px-4 py-3 text-gray-700">{r.option}</td>
                    <td className="px-4 py-3 text-right text-gray-800">{(r.product_price ?? 0).toLocaleString()}원</td>
                    <td className="px-4 py-3 text-right text-gray-800">{r.review_cost.toLocaleString()}원</td>
